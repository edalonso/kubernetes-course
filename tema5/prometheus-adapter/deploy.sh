...
kubectl -n custom-metrics create -f custom-metrics-apiserver-deployment.yaml
kubectl create -f custom-metrics-apiserver-resource-reader-cluster-role-binding.yaml
kubectl -n custom-metrics create -f custom-metrics-apiserver-service-account.yaml
kubectl -n custom-metrics create -f custom-metrics-apiserver-service.yaml
